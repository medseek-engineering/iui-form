...
(function () {
  ...
  angular.module('iuiForm').directive('iuiAutoComplete', ['$http', '_', '$timeout', function (http, _, timeout) {
    return {
      restrict: 'E',
      require: 'ngModel',
...
(function () {
  ...
  angular.module('iuiForm').directive('iuiDropDown', ['$filter', '$rootScope', '$timeout', 'DropDownListItemsSvc', '_', '$log', function ($filter, $rootScope, timeout, listItemsSvc, _, log) {
    return {
      restrict: 'E',
      require: 'ngModel',
...
(function () {
  ...
  angular.module('iuiForm').directive('iuiEmail', [function () {
    return {
      restrict: 'A',
      require: 'ngModel',
      link: function link(scope, element, attrs, ngModel) {
...
(function () {
  ...
  angular.module('iuiForm').directive('iuiLabel', [function () {
    return {
      restrict: 'E',
      require: 'ngModel',
...
(function () {
  ...
  angular.module('iuiForm').directive('iuiMultiSelect', ['$q', '$filter', '_', 'DropDownListItemsSvc', '$timeout', function ($q, $filter, _, listItemsSvc, timeout) {
    return {
      restrict: 'E',
      require: 'ngModel',
      scope: {
...
(function () {
  ...
  angular.module('iuiForm').directive('iuiRadioList', ['$filter', function ($filter) {
    return {
      restrict: 'E',
      require: '?ngModel',
      transclude: true,
...
(function () {
  ...
  angular.module('iuiForm').directive('iuiTextBox', ['session', '$translate', function (session, translate) {
    return {
      restrict: 'E',
      require: 'ngModel',
...
(function () {
  ...
  angular.module('iuiForm').directive('iuiZipTextBox', ['$rootScope', '$translate', function (rootScope, translate) {
    return {
      restrict: 'E',
      require: 'ngModel',
...
(function () {
  ...
  angular.module('iuiForm').directive('iuiTextAllowDigits', ['$translate', function (translate) {
    return {
      restrict: 'A',
      require: 'ngModel',
      link: function link(scope, element, attrs, ngModel) {
...
(function (module) {
  ...
  module.run(['$templateCache', function ($templateCache) {
    $templateCache.put('/$iui-form/iui-form-fields/iui-checkbox/iui-checkbox.html', '<div class="iui-checkbox">\n' + '  <input\n' + '    class="custom-checkbox"\n' + '    id="{{field.id}}"\n' + '    name="{{field.name}}"\n' + '    type="checkbox"\n' + '    ng-model="selected"\n' + '    ng-disabled="{{field.valueReadOnly}}">\n' + '  <label \n' + '	  for="{{field.id}}"\n' + '	  ng-bind="field.label">\n' + '	</label>\n' + '</div>');
  }]);
})();
