...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/$iui-form/iui-form-fields/iui-Social-Security-Number-TextBox/iui-Social-Security-Number-TextBox.html',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/$iui-form/iui-form-fields/iui-access-drop-down/iui-access-drop-down.html',
    '  <div class="row mf-access-drop-down">\n' +
    '    <div class="col-xs-11">\n' +
