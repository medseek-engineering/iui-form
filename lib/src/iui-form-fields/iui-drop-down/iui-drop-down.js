(function() {
  ...
  angular.module('iuiForm')
   .directive('iuiDropDown', ['$filter', '$rootScope', '$timeout', 'DropDownListItemsSvc', '_', '$log', 
   function ($filter, $rootScope, timeout, listItemsSvc, _, log) {
    return {
      restrict: 'E',
      require: 'ngModel',
      ...
      link: function (scope, element, attributes, ngModel) {
        ...
        ngModel.$render = function () {
          var model = scope.model = ngModel.$modelValue ? 
            (ngModel.$modelValue.id || ngModel.$modelValue.toString()) : undefined;
